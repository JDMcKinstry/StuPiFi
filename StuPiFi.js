...
;(function() {	//	Date.format 	//	requires Date[addHours, getDayName, getWeek]
	...
	function dateFormat(str, utc) {	//	string, boolean TODO: use utc bool to determine in converter methods if to use UTC version
		if (str) {
			...
			else if (Date.prototype.format.compound[str]) return this.format(Date.prototype.format.compound[str]);
			...
			else if (Date.prototype.format.constants[str]) return this.format(Date.prototype.format.constants[str]);
